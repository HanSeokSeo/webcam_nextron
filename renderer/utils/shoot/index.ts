...
function useShowClickedImage(
  isCaptureMode: boolean,
  setIsCaptureMode: Dispatch<SetStateAction<boolean>>,
  setClickedImageSrc: Dispatch<SetStateAction<string>>
) {
  return useCallback(
    (src: string) => {
      if (isCaptureMode) {
    ...
    [isCaptureMode, setIsCaptureMode, setClickedImageSrc]
  )
}

export { deleteImage, captureImage, useShowClickedImage }
